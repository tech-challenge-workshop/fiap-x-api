...
| Evidence | Run |
| --- | --- |
| Required check `quality` turned **red** on a deliberate lint error, failing at `Run npm run lint` | [35538768605](https://github.com/tech-challenge-workshop/fiap-x-api/actions/runs/35538768605) |
| Reverting the probe turned `quality` **green** | [35538834350](https://github.com/tech-challenge-workshop/fiap-x-api/actions/runs/35538834350) |
