...
This repository intentionally contains no NestJS scaffold or infrastructure configuration yet. The approved system architecture is in the workspace's `docs/foudation.md`.
